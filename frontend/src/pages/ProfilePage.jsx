...
export default function ProfilePage() {
  ...
  return <main className="relative isolate min-h-screen bg-ink text-white pt-20 pb-16 overflow-hidden">
    ...
    <Navbar />
    <div className="wrap py-12 sm:py-16"><div className="mx-auto max-w-4xl"><div className="mb-10"><p className="eyebrow text-mint">Build your profile</p><h1 className="mt-4 text-3xl font-extrabold tracking-[-.04em] text-white sm:text-4xl">Tell us about the experience you bring.</h1><p className="mt-4 max-w-2xl leading-7 text-slate-300">Start manually, or upload a resume to keep a reference handy. We will not parse or send any file in this version.</p></div>
